 ...
 *
 * Please note that rest parameters are not supported: all parameters need individual names
 *
...
/**
 * @summary Transform an array to an object, assigning each array item to a given property.
 * @description Provided values that doesn't have any expected properties will be kept in the
...
/**
 * @summary Check if the exposed apis is acceptable for further processing
...
/**
 * @summary Extract API groups and API options from parameter
 * @description API groups are objects compliant with mini-service-utils.groupSchema.
